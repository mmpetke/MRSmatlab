...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% settings 
settings.startWaitTime = 0.1; % in seconds
settings.maxWaitTime   = 5.0; % in seconds
settings.maxIdleTime = inf; % in seconds
settings.firstWarnTime = 10; % in seconds
settings.startWarnTime = 10 * 60;   % in seconds
settings.maxWarnTime   = 24 * 3600; % in seconds
settings.debugMode    = 0;
settings.showWarnings = 0;

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% slave file directory name
