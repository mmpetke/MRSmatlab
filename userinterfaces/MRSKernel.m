...
if nargin > 0   % i.e. command comes from MRSWorkflow
    ...
    function gui = createInterface()
        ...
        uilooppre  = uiextras.BoxPanel('Parent', uiloop1, 'Title', 'Prepolarisation Loop', 'visible', 'off');
        ...
        uimeaspre  = uiextras.BoxPanel('Parent', uimeasp1, 'Title', 'Prepolarisation Parameter', 'visible', 'off');
